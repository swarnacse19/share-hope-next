...
function Footer() {
  return (
    <footer className="bg-white text-[14px] py-14">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col gap-8 md:flex-row justify-between">
        ...
        <div>
          ...
          <div className="flex space-x-4 text-gray-600">
            <a href="#" className="hover:text-gray-900"><FaTwitter size={24} /></a>
            <a href="#" className="hover:text-gray-900"><FaLinkedin size={24} /></a>
            <a href="#" className="hover:text-gray-900"><IoLogoFacebook size={24} /></a>
            <a href="#" className="hover:text-gray-900"><IoLogoYoutube size={24} /></a>
          </div>
        </div>
      </div>
