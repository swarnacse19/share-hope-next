  ...
  if (!campaign) {
    return (
      <div className="container mx-auto px-4 py-16 text-center">
        ...
        <p className="text-lg text-gray-600 mt-4">The campaign you are looking for does not exist or has been removed.</p>
      </div>
    );
  }

  // Calculate percentage raised
  const percentage = Math.min(100, Math.round((campaign.raisedAmount / campaign.goalAmount) * 100));
      ...
      <div className="bg-white rounded-xl shadow-2xl overflow-hidden">
        <div className="lg:grid lg:grid-cols-3">
          ...
          <div className="lg:col-span-2 p-6 md:p-10">
            ...
            {/* Description */}
            <h2 className="text-2xl font-bold text-gray-700 mb-4 border-b pb-2">About the Program</h2>
            ...
            <div className="mt-8 pt-8 border-t border-gray-200">
                <h3 className="text-xl font-bold text-gray-700 mb-4">Recent Donors ({campaign.donors.length})</h3>
                <ul className="space-y-2 text-gray-600 text-sm max-h-40 overflow-y-auto">
                    {campaign.donors.slice(0, 5).map((donor, index) => (
                        <li key={index} className="flex justify-between border-b border-gray-100 pb-1">
                            <span className="font-medium">{donor.donorId.split('@')[0]}***</span>
                            <span className="font-semibold text-green-700">{formatCurrency(donor.amount)}</span>
                        </li>
                    ))}
          ...
          <div className="lg:col-span-1 p-6 md:p-10 bg-gray-50/70 lg:border-l border-gray-100">
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100 mb-8 sticky top-10">
                ...
                <p className="text-sm text-gray-600 mb-4">
                    raised of <span className="font-semibold">{formatCurrency(campaign.goalAmount)}</span> goal
                </p>
                ...
                <p className="text-center text-xs text-gray-500 mt-4">
                    Campaign created by: <span className="font-semibold text-gray-700">{campaign.createdBy}</span>
                </p>
            </div>
            ...
            <div className="mt-6 text-center">
                <div className='flex justify-center items-center gap-2'>
                    <p className="text-sm font-medium text-gray-700 mb-2">Share this campaign</p>
